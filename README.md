...
- This project deploys a simple Single Page Application built using [Vue.js](https://svelte.dev/) and
...
```bash
stacktape init --projectId svelte-spa-vitejs
```
